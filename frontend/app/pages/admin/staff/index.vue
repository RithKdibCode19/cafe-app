    ...
    <div class="space-y-6">
      ...
      >
        ...
        <div v-if="activeTab === 'shifts'" class="card overflow-hidden">
          <div
            class="p-4 bg-neutral-50 dark:bg-neutral-800/50 border-b border-neutral-200 dark:border-neutral-700 flex justify-between items-center"
          >
            ...
            <table class="w-full text-sm">
              ...
              >
                ...
                <tr
                  ...
                  :key="shift.shiftId"
                  class="hover:bg-neutral-50 dark:hover:bg-neutral-800/30 transition-colors border-b border-neutral-200 dark:border-neutral-700"
                >
                  ...
                  <td class="px-6 py-4 text-right">
                    <button
                      ...
                      class="p-1.5 text-error-500 hover:bg-error-50 rounded-lg"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4"
        ...
        <div v-if="activeTab === 'attendance'" class="card overflow-hidden">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm">
              <thead>
                <tr
                  class="bg-neutral-50 dark:bg-neutral-800/50 text-left border-b border-neutral-200 dark:border-neutral-700"
                >
                  <th class="px-6 py-3 font-bold text-[10px] uppercase">
                    Employee
                  </th>
                  <th class="px-6 py-3 font-bold text-[10px] uppercase">
                    Clock In
              ...
              >
                ...
                >
                  ...
                  <td class="px-6 py-4 font-mono text-xs">
                    {{
                      att.checkOut
                        ? new Date(att.checkOut).toLocaleString()
                        : "-"
                    }}
                  </td>
                  <td class="px-6 py-4">
