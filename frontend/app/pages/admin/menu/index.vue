    ...
    <div class="space-y-6 relative">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div
          ...
          :key="item.menuItemId"
          class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 overflow-hidden hover:shadow-lg transition-shadow group"
        >
          <div
          ...
          <div class="p-4">
            <div class="flex justify-between items-start mb-2">
              <h3
                class="font-semibold text-neutral-900 dark:text-white truncate pr-2"
                :title="item.name"
              >
                {{ item.name }}
              </h3>
            ...
            >
              <button
                @click="deleteItem(item.menuItemId)"
                class="text-xs text-neutral-400 hover:text-error-600 transition-colors"
              >
                Delete
              </button>
              <button
      ...
      >
        <div
          class="bg-white dark:bg-neutral-900 rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 flex flex-col max-h-[90vh]"
        >
          <!-- Modal Header -->
          <div
            class="p-6 border-b border-neutral-200 dark:border-neutral-800 flex justify-between items-center bg-white dark:bg-neutral-900 sticky top-0"
          >
          ...
          <div class="flex-1 overflow-y-auto p-6 scrollbar-thin">
            ...
            <div
              v-if="isEditing"
              class="flex gap-4 mb-6 border-b border-neutral-200 dark:border-neutral-800"
            >
              <button
              ...
              >
                ...
                <div
                  ...
                  class="absolute bottom-0 left-0 w-full h-0.5 bg-primary-600 dark:bg-primary-400 rounded-full"
                ></div>
              </button>
              <button
            ...
            <div v-if="activeModalTab === 'recipe'" class="space-y-6">
                ...
                <div class="flex gap-3">
                  <div class="flex-1">
                    <select
                      ...
                      class="w-full bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg p-2 text-sm focus:ring-2 focus:ring-primary-500"
                    >
              ...
              <div>
                ...
                <div
                  ...
                  class="text-sm text-neutral-500 italic text-center py-4 bg-neutral-50 dark:bg-neutral-800/30 rounded-lg"
                >
                ...
                <div v-else class="space-y-2">
                  <div
                    ...
                    :key="rec.recipeId"
                    class="flex items-center justify-between p-3 bg-white dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800 rounded-lg"
                  >
                    <div class="flex items-center gap-3">
                      <div
                    ...
                    <button
                      ...
                      class="text-neutral-400 hover:text-error-600 p-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4"
            ...
            <div v-if="activeModalTab === 'variants'" class="space-y-6">
              ...
              >
                ...
                <p class="text-xs text-neutral-500 flex justify-between">
                  <span>Base Price: ${{ form.basePrice.toFixed(2) }}</span>
                  <span
          ...
          <!-- Modal Footer -->
          <div
            class="p-6 bg-neutral-50 dark:bg-neutral-800/50 flex justify-end gap-3 sticky bottom-0"
          >
            <button
              @click="closeModal"
...
const filteredItems = computed(() => {
  ...
  if (filterCategory.value) {
    result = result.filter(
      (item) => item.category?.categoryId === Number(filterCategory.value),
    );
  }
...
const openCreateModal = () => {
  ...
  form.categoryId =
    categories.value.length > 0
      ? (categories.value[0]?.categoryId ?? null)
      : null;
  form.basePrice = 0;
  form.imageUrl = "";
